...
public class LoginController {
    ...
    @Operation(summary = "跳转到登录地址",description = "跳转到登录地址")
    public String login(Model model,HttpServletResponse response){
        boolean captchaOpen = properties.isCaptchaOpen();
        LOGGER.info("请求验证码开关,captchaOpen:{}",captchaOpen);
    ...
    @PostMapping("/login")
    @ResponseBody
    @Operation(summary = "执行登录请求地址",description = "执行登录请求地址")
    public Result login(@Validated @ParameterObject LoginRequest loginRequest){
